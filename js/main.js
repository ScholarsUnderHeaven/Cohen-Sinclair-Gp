...
/* Theme System */
var THEME_L = {canvas:[233,230,222,1], plateau:[226,221,210,.78], shd:[88,82,70,.18], shl:[255,253,246,.8], edge:[255,253,246,.65], bevlo:[88,82,70,.08], ink:[42,38,32,1], inks:[97,85,71,1], blue:[97,85,71,1], onacc:[255,255,255,1], arc:[255,255,255,.9]};
var THEME_D = {canvas:[44,32,26,1], plateau:[97,85,71,.78], shd:[60,40,25,.5], shl:[255,240,220,.05], edge:[220,190,150,.10], bevlo:[60,40,25,.45], ink:[245,232,216,1], inks:[200,176,146,1], blue:[97,85,71,1], onacc:[44,32,26,1], arc:[220,190,150,.15]};
var lastNight = -1;
