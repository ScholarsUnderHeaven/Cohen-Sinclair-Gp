...
/* Theme System */
var THEME_L = {canvas:[233,230,222,1], plateau:[226,221,210,.78], shd:[88,82,70,.18], shl:[255,253,246,.8], edge:[255,253,246,.65], bevlo:[88,82,70,.08], ink:[42,38,32,1], inks:[139,115,85,1], blue:[139,115,85,1], onacc:[255,255,255,1], arc:[255,255,255,.9]};
var THEME_D = {canvas:[44,32,26,1], plateau:[226,221,210,.78], shd:[88,82,70,.35], shl:[220,200,180,.12], edge:[200,180,150,.15], bevlo:[88,82,70,.25], ink:[224,216,200,1], inks:[200,184,160,1], blue:[139,115,85,1], onacc:[44,32,26,1], arc:[200,180,150,.20]};
var lastNight = -1;
